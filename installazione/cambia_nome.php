...
<html lang="it">
    ...
    <body>
        <div id="wrap">
            <div class="container-fluid text-center">
                ...
                <div class="row">
                    <form id="installform" class="form-signin" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <input class="input-block-level" name="email" placeholder="Email del master" type="text" />
                        <input class="input-block-level" name="username" placeholder="Username del master" type="text" />
                        <input class="input-block-level" name="password" placeholder="Password master" type="text" />
                        ...
                        <?php } ?>
                        <button class="btn btn-large btn-primary" type="submit" id="installa">
                            Installa
                        </button><br /><br />
                    </form>  
                </div>
            ...
            ?>
        <script type="text/javascript" src="../librerie/jquery-1.10.2.min.js"></script>
